...
3. State any two research questions and perform hypotheses testing based on the two research questions. Explain why your team chose the statistical tests used and interpret your results. 

4. Build any two regression models that use your choice of covariates to predict the given outcome variable. Explain why you chose those covariates and interpret the model performances. 



5. The company stakeholders want to know what decision they should make on their stated goal/question. Based on your analysis, make recommendations for a non-technical audience. 

6. Any additional information that might be useful to collect/have? Other open-ended/non-coding question(s)? 
